...
class Matras_model extends CI_model {
    ...
    public function hapusDataMatras($id_tool){
        // $this->db->where('id', $id);
        $this->db->delete('tools', ['id_tool' => $id_tool]);
    }

    public function getMatrasById($id_tool){
        return $this->db->get_where('tools', ['id_tool' => $id_tool])->row_array();
    }

    public function cariDataMatras(){
