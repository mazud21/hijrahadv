...
class Lamp_model extends CI_model {
    ...
    public function tambahDataLamp($upload){
        $data = array(
            'nama'       => $this->input->post('nama'),
            'merk'       => $this->input->post('merk'),
    ...
    public function hapusDataLamp($id_tool){
        // $this->db->where('id', $id);
