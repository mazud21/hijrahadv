                                        ...
                                        <div class="col">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                            <label for=""><h6 class="card-subtitle text-muted">Nomor Kompor Portable</h6></label><br>
                                                            <?= $tool['id_tool']; ?>
                                                        </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                            <label for=""><h6 class="card-subtitle text-muted">Foto Kompor Portable</h6></label><br>
