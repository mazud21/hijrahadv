                                ...
                                <div class="row mt-3">
                                    <div class="card">
                                        <div class="card-header">
                                                Form Edit Data Gas Portable
                                        </div>

                                        <div class="card-body">
                                            <?php echo form_open("server/tools/gas/updatedata", array('enctype'=>'multipart/form-data')); ?>
                                            ...
                                            <div class="row">
                                                <div class="col-sm">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="volume" class="form-control" id="volume" value="<?= $tool['volume'];?>">
