                    ...
                    <div class="container">
                        <div style="color: red;"><i><?php echo (isset($message))? $message : ""; ?></i></div>
                            ...
                            <div class="row mt-3">
                                <div class="card">
                                    <div class="card-body">
                                        <?php echo form_open("server/tools/gas/tambah", array('enctype'=>'multipart/form-data')); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-sm">
                                                <div class="form-group">
                                                    <label for="nama">Nama Gas Portable</label>
                                            ...
                                            <div class="col-sm">
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_jenis" id="id_jenis" class="form-control" readonly disable>
                                                        <option value="6">Gas Portable</option>
                                                    </select>
                                        ...
                                        <div class="row">
                                            <div class="col-sm">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="volume" class="form-control" id="volume" placeholder="-" value="coba">
