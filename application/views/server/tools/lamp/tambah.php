                    ...
                    <div class="container">
                        <div style="color: red;"><i><?php echo (isset($message))? $message : ""; ?></i></div>
                            ...
                            <div class="row mt-3">
                                <div class="card">
                                    <div class="card-body">
                                        <?php echo form_open("server/tools/lamp/tambah", array('enctype'=>'multipart/form-data')); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-sm">
                                                <div class="form-group">
                                                    <label for="nama">Nama Head Lamp</label>
                                            ...
                                            <div class="col-sm">
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_jenis" id="id_jenis" class="form-control" readonly disable>
                                                        <option value="8">Head Lamp</option>
                                                    </select>
                                        ...
                                        <div class="row">
                                            <div class="col-sm">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="model" class="form-control" id="model" placeholder="-" value="coba">
