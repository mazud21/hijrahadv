                                        ...
                                        <div class="col">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group">
                                                            <label for=""><h6 class="card-subtitle text-muted">Nomor Nesting Cook Set</h6></label><br>
                                                            <?= $tool['id_tool']; ?>
                                                        </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                            <label for=""><h6 class="card-subtitle text-muted">Foto Nesting Cook Set</h6></label><br>
                                                    ...
                                                    <div class="form-group">
                                                            <label for=""><h6 class="card-subtitle text-muted">Bahan</h6></label><br>
                                                            <?= $tool['outer_']; ?>
                                                        </div>
