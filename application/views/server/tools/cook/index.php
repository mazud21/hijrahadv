...
<html lang="en">
    <head>
    <title>Cooking Set Hijrah Adventure</title>
                        ...
                        <div class="row mt-0">
                            ...
                            <div class="row mt-0">
                                <div class="col-md-6">
                                    ...
                                    <?php $this->load->view("server/tools/cook/tambah.php") ?>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a data-toggle="modal" data-target="#detail_modal<?= $tool['id_tool']; ?>">
                                                        ...
                                                        <?php $this->load->view("server/tools/cook/detail.php") ?>
                                                    </a>
                                                    <a data-toggle="modal" data-target="#edit_modal<?= $tool['id_tool']; ?>">
                                                        ...
                                                        <?php $this->load->view("server/tools/cook/ubah.php") ?>
                                                    
                                                    <a href="<?= base_url(); ?>server/tools/cook/hapus/<?= $tool['id_tool']; ?>">
