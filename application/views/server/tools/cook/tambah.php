                    ...
                    <div class="container">
                        <div style="color: red;"><i><?php echo (isset($message))? $message : ""; ?></i></div>
                            ...
                            <div class="row mt-3">
                                <div class="card">
                                    <div class="card-body">
                                        <?php echo form_open("server/tools/cook/tambah", array('enctype'=>'multipart/form-data')); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-sm">
                                                <div class="form-group">
                                                    <label for="nama">Nama Cooking Set</label>
                                            ...
                                            <div class="col-sm">
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_jenis" id="id_jenis" class="form-control" readonly disable>
                                                        <option value="7">Nesting Cook Set</option>
                                                    </select>
