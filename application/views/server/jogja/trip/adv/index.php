...
<html lang="en">
    <head>
    <title>Trip Journeysia.ID</title>
                            ...
                            <div class="card-body">
                                <p class="mb-0">
                                    <div class="row mt-3">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-6">
                                                <a href="<?= base_url(); ?>server/jogja/trip/tambah" class="btn btn-primary">Tambah
                                                    Data tagihan</a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <table class="table table-bordered table-striped mb-0" id="dtVerticalScrollExample">
                                            <thead>
                                            <tr>
                                                <th scope="col">Id Trip</th>
                                                <th scope="col">Nama Trip</th>
                                                <th scope="col">Gambar Trip</th>
                                            ...
                                            <tr>
                                                <td><?= $tr['id_journey']; ?></td>
                                                <td><?= $tr['judul']; ?></td>
                                                <td><img src="<?= base_url("images/".$tr['gambar']); ?>" alt="image.png" width="200px"></td>
                                                <td><a href="<?= base_url(); ?>server/jogja/trip/Trip/hapus/<?= $tr['id_journey']; ?>"
                                                                class="badge badge-danger float-right tombol-hapus">hapus</a>
                                                            <a href="<?= base_url(); ?>server/jogja/trip/Trip/edit/<?= $tr['id_journey']; ?>"
                                                                class="badge badge-success float-right">ubah</a>
                                                            <a href="<?= base_url(); ?>server/jogja/trip/Trip/detail/<?= $tr['id_journey']; ?>"
